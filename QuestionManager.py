...
class QuestionManager:
    ...
    def create_multiple_choice_question(self, question_type, question_text):
        while True:
            try:
    ...
    def add_question_menu(self):
        ...
        while True:
            ...
            if question_type == "1" or question_type == "2":
                ...
                if not question_text or len(question_text) < 5:
                    ...
                    if question_type == "1":
                        ...
                        question_type = "multiple_choice_q_type"
                        new_question = self.create_multiple_choice_question(
                            question_type, question_text
                        )
            ...
            elif question_type.lower().strip() == "m":
